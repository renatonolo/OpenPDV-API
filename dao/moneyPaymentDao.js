function MoneyPaymentDAO(db){
    this.db = db;

    this.getByUuid = function(uuid, callback){
        if(!uuid) return false;

        var sql = "SELECT * FROM money_payments WHERE uuid = '" + uuid + "'";
    ...
    this.insert = function(payment, callback){
        ...
        var sql = "INSERT INTO money_payments (uuid, sale, value) VALUES ('" + payment.uuid + "', '" + payment.sale + "', " + payment.value + ")";
...
module.exports = MoneyPaymentDAO;
